...
START TRANSACTION;
USE `EventTrackerDB`;
INSERT INTO `pet_owned` (`id`, `owner_id`, `name`, `animal_type`, `breed`, `age`, `is_on_property`) VALUES (1, 1, 'Leo', 'DOG', 'Shepherd Mix', 1, 1);
INSERT INTO `pet_owned` (`id`, `owner_id`, `name`, `animal_type`, `breed`, `age`, `is_on_property`) VALUES (5, 1, 'Lora', 'CAT', 'Maine Coon', 2, 1);
INSERT INTO `pet_owned` (`id`, `owner_id`, `name`, `animal_type`, `breed`, `age`, `is_on_property`) VALUES (4, 1, 'Ben', 'DOG', 'Bernese Mountain Dog', 4, 1);
INSERT INTO `pet_owned` (`id`, `owner_id`, `name`, `animal_type`, `breed`, `age`, `is_on_property`) VALUES (3, 2, 'Barbie', 'CAT', 'Persian Mix', 13, 1);
INSERT INTO `pet_owned` (`id`, `owner_id`, `name`, `animal_type`, `breed`, `age`, `is_on_property`) VALUES (2, 3, 'Ada', 'DOG', 'Labrador Mix', 8, 1);
INSERT INTO `pet_owned` (`id`, `owner_id`, `name`, `animal_type`, `breed`, `age`, `is_on_property`) VALUES (6, 4, 'Bernie', 'DOG', 'Labrador Mix', 6, 1);
